...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/jul10-newrepons-1](https://github.com/jdubrick-ai/jul10-newrepons-1)

    **GitOps Repository:** [https://github.com/jdubrick-ai/jul10-newrepons-1-gitops](https://github.com/jdubrick-ai/jul10-newrepons-1-gitops)

# **Usage**

To access the jul10-newrepons-1 application that was deployed using the Software Template, complete the following instructions:
